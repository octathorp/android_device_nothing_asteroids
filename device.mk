...
CONFIG_HAL_SRC_DIR := $(AUDIO_HAL_DIR)/configs/volcano
CONFIG_PAL_SRC_DIR := $(AUDIO_HAL_DIR)/../pal/configs/volcano
CONFIG_SKU_OUT_DIR := $(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_volcano
CONFIG_SKU_QSSI_OUT_DIR := $(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_volcano_qssi

PRODUCT_COPY_FILES += \
    $(AUDIO_HAL_DIR)/configs/common/audio_policy_configuration.xml:$(CONFIG_SKU_OUT_DIR)/audio_policy_configuration.xml \
    $(LOCAL_PATH)/audio/audio_policy_configuration.xml:$(CONFIG_SKU_QSSI_OUT_DIR)/audio_policy_configuration.xml \
    frameworks/av/services/audiopolicy/config/audio_policy_volumes.xml:$(CONFIG_SKU_OUT_DIR)/audio_policy_volumes.xml \
    $(LOCAL_PATH)/audio/audio_policy_volumes.xml:$(CONFIG_SKU_QSSI_OUT_DIR)/audio_policy_volumes.xml \
    frameworks/av/services/audiopolicy/config/default_volume_tables.xml:$(CONFIG_SKU_OUT_DIR)/default_volume_tables.xml \
    $(LOCAL_PATH)/audio/default_volume_tables.xml:$(CONFIG_SKU_QSSI_OUT_DIR)/default_volume_tables.xml
...
PRODUCT_PACKAGES += \
    ...
    FrameworksResCommon_Asteroids \
    FrameworksResCommon_Sys \
    FrameworksResCommon_Sys_All \
    ...
    WifiResMainlineOverlay_Asteroids \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/init.qti.graphics.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.qti.graphics.rc \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/bin/init.qti.graphics.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.qti.graphics.sh \
...
PRODUCT_PACKAGES += \
    firmware_peach_v2_WCNSS_qcom_cfg.ini_symlink \
    firmware_peach_v2_wlan_mac.bin_symlink \
